...
function Card({ item }) {
  ...
  return (
    <div className="group relative cursor-pointer w-96 h-[416px] bg-lightgray text-darkgray p-8 rounded-4xl font-roboto hover:bg-red hover:text-white transition-all duration-300 ease-in-out">
